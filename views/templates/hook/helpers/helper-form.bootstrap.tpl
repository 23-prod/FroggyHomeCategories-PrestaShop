 ...
 *}
        ...
        {foreach from=$froggyhelper.configuration.form key=form_key item=form}
            ...
            {foreach from=$form.fields item=field}
                <div class="form-group">
                    <label class="control-label col-lg-3" for="{$field.name|escape:'htmlall':'UTF-8'}"> {$field.label|escape:'htmlall':'UTF-8'}</label>
                    <div class="col-lg-9 ">
                        {if $field.type eq 'radio'}
                            <span class="switch prestashop-switch fixed-width-lg">
                                    ...
                                    <label for="{$field.name|escape:'htmlall':'UTF-8'}_on"> {l s='Yes' mod='froggyhomecategories'}</label>
                                    ...
                                    <label for="{$field.name|escape:'htmlall':'UTF-8'}_off"> {l s='No' mod='froggyhomecategories'}</label>
		...
		<div class="panel-footer">
			<button class="btn btn-default pull-right" name="{$froggyhelper.module_name|escape:'htmlall':'UTF-8'}-submit" id="{$froggyhelper.module_name|escape:'htmlall':'UTF-8'}-form-submit-btn" value="1" type="submit">
				<i class="process-icon-save"></i> {l s='Save' mod='froggyhomecategories'}
			</button>
		</div>
