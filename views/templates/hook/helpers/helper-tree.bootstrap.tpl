...
<input type="button" id="category-tree-select-all-{$categories_tree_id|intval}" value="{l s='Select all' mod='froggyhomecategories'}" class="btn btn-default" />
<input type="button" id="category-tree-unselect-all-{$categories_tree_id|intval}" value="{l s='Unselect all' mod='froggyhomecategories'}" class="btn btn-default" />
<br>
