...
class FroggyHelperTreeCategories
{
	...
	public function render()
	{
		...
		return $this->module->fcdisplay(dirname(__FILE__).'/../../'.$this->module->name, 'froggy/helpers/helper-tree.tpl');
	}
	...
	public function renderTreeBranch($categories)
	{
		...
		return $this->module->fcdisplay(dirname(__FILE__).'/../../'.$this->module->name, 'froggy/helpers/helper-tree-branch.tpl');
	}
